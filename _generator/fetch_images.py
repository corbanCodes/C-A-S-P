...
QUERIES = [
    "wheelchair ramp entrance building",
    "accessible parking space sign painted",
    "curb ramp sidewalk detectable warning",
    "tactile paving truncated domes",
    "accessible restroom grab bars",
    "wheelchair accessible entrance door",
    "handrail staircase building interior",
    "elevator braille tactile button",
    "building inspector inspection clipboard",
    "architectural blueprint construction plans",
    "storefront small business street california",
    "california street commercial building",
    "accessible pedestrian signal push button",
    "hotel lobby reception desk",
    "restaurant interior dining tables",
    "office building lobby entrance glass",
    "spirit level measuring tape tool",
    "wheelchair user sidewalk city",
    "parking lot accessible stall van",
    "ramp handrail concrete accessibility",
]
